...
//
// Universo acotado a ~300 nombres (compartido con compute-fundamentals.mjs
// via _universe.mjs): calcular esto en vivo para todo el mercado en cada
// carga de pagina seria pesado y lento -- por eso se precalcula y se
// guarda.
